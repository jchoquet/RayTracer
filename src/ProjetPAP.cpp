...
int main() {
	...
	tab_S.push_back(new Sphere(Material(155,127,2550,0), Vector3f(1300,300,0), (float) 50)); // sphere
	tab_S.push_back(new Sphere(Material(255,127,0,0), Vector3f(1200,0,0), (float) 200));
